...
class ProgramServiceTest {
    ...
    @DisplayName("등록되지 않은 프로그램을 수정할 때 예외가 발생한다")
    @Test
    void modifyProgram2(){
        //given //when
        ProgramModifyRequest request = ProgramModifyRequest.builder()
    ...
    @DisplayName("프로그램을 수정할 때 존재하지 않는 회원으로 수정하면 예외가 발생한다")
    @Test
    void modifyProgram3(){
        //given //when
    ...
    @DisplayName("프로그램을 수정할 때 존재하지 않는 트레이너로 수정하면 예외가 발생한다")
    @Test
    void modifyProgram4(){
        //given //when
        Product product = initProduct("pt 30회권", "30",30,ProductType.MEMBERSHIP);
    ...
    //환불 요청
    @DisplayName("이미 환불 된 프로그램을 환불하면 예외가 발생한다.")
    @Test
    ...
    @DisplayName("등록되지 않은 프로그램을 환불시 예외가 발생한다.")
    @Test
    void refundProgram2(){
        LocalDateTime localDateTime = LocalDateTime.now();
        //then
    ...
    @DisplayName("요청한 등록으로 이미 프로그램이 등록되어 있으면 예외가 발생한다")
    @Test
    ...
    @DisplayName("존재하지 않는 트레이너로 등록시 예외가 발생한다")
    @Test
    ...
    @DisplayName("pt권에서 트레이너를 선택하지 않고 등록시 예외가 발생한다.")
    @Test
    ...
    void findInProgressProgramByUser(){
        ...
        //when
        List<ProgramResponse> results1 = programService.find(member1.getId(), ProgramSearchStatus.INVALID);
        List<ProgramResponse> results2 = programService.find(member2.getId(), ProgramSearchStatus.INVALID);
    ...
    void findInProgressProgramByEmployee(){
        ...
        //when
        List<ProgramResponse> results1 = programService.find(trainer.getMember().getId(), ProgramSearchStatus.INVALID);
        List<ProgramResponse> results2 = programService.find(trainer2.getMember().getId(), ProgramSearchStatus.INVALID);
    ...
    void findAllProgramByUser(){
        ...
        //when
        List<ProgramResponse> results1 = programService.find(member1.getId(), ProgramSearchStatus.ALL);
    ...
    void findAllProgramByEmployee(){
        ...
        //when
        List<ProgramResponse> results1 = programService.find(trainer.getMember().getId(), ProgramSearchStatus.ALL);
